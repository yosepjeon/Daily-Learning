...
6. 클린코드[0/5]
7. 오브젝트 코드로 이해하는 객체지향 설계[0/5] [307p -> 345p]
8. kotlin in action[0/5] [32p -> 77p]
9. optimizing java[0/5] [0p -> 40p]
10. 데이터중심 애플리케이션 설계[0/5]
11. 다재다능 코틀린 프로그래밍[0/5] [92p -> 109p]
12. 이펙티브 코틀린[1/3] [아이템 13 ~ 18] 사내 스터디 중 이건 아이템 6개씩 3회독
...
언어
1. Node.JS 취미로 조지기 (선행학습: 자바스크립트 다시 깔짝, NodeJS책) 강의
